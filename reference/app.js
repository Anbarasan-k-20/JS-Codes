...
//   let lsTask;
//   if (localStorage.getItem("taskItemLs") === null) {
//     lsTask = [];
//   } else {
//     lsTask = JSON.parse(localStorage.getItem("taskItemLs"));
//   }
//   lsTask.push(inputVal);
//   localStorage.setItem("taskItemLs", JSON.stringify(lsTask));
// };
